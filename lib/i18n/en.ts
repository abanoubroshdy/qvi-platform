export const en = {
  ...
  privacy: {
    ...
    cookies: [
      ...
      "localStorage keys on this device: qvi-locale, qvi-theme, qvi-recent-colors, and qvi-neyora-last-prompt. These stay in your browser and are not sent to our database.",
