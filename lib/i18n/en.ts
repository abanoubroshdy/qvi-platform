export const en = {
  ...
  pdfToWord: {
    ...
    modeAuto: "Auto — editable text, hybrid preview for complex pages, visual copy for scans",
    modeEditable: "Editable text — reconstruct words, size, bold, and images",
    modeHybrid: "Hybrid — editable text plus a visual page preview",
    modeVisual: "Visual copy — each page as a high-resolution image",
    modeHint: "Auto prefers editable text. Complex forms get a hybrid preview; scanned pages become a visual copy.",
    badFormat: "Unsupported format. Choose a PDF file.",
