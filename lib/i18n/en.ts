export const en = {
  ...
  auth: {
    ...
    downloadsEmpty: "No QV1 downloads yet.",
    downloadsUnavailable: "Download history isn’t available yet.",
    downloadsVersion: "Version {version}",
  ...
  home: {
    ...
    closingLead: "Download QV1 Evaluation or follow Neyora. Write to us about the desktop products, your account, or a free tool.",
    closingContact: "Contact us",
  },
  toolGroups: {
    audio: {
      title: "Audio & video tools",
      lead: "Extract audio, convert video, and trim clips — FFmpeg runs on your device.",
    },
    images: {
      title: "Image tools",
  ...
  qv1Page: {
    ...
    privacy: "Privacy",
    stemsTitle: "4 AI stems — free (Evaluation)",
    stemsLead:
    ...
    requirementGpuValue: "NVIDIA GPU optional",
    requirementCpu: "Processor",
    requirementCpuValue: "CPU works",
    changelogTitle: "Changelog",
    versionLabel: "Version",
  },
  qv1Models: {
    title: "Model sources & licenses",
    lead:
      "QV1 Evaluation does not include a QVI separation model. The weights below are third-party, non-commercial, and downloaded after you accept a notice.",
    colName: "Name",
    colSource: "Original source",
    colFormat: "Format",
    colLicense: "License status",
    colSha: "SHA256 (ONNX)",
    formatValue: "ONNX, converted by QVI from .ckpt",
    license:
      "Non-commercial — license not stated by the author; trained on MUSDB18 (academic use)",
    shaMissing: "Published with the model file",
    notOriginal: "This model is not a QV1 original.",
    runtimeTitle: "Libraries in the app",
    openSource: "License",
    copyrightBefore: "The QV1 app code is ©",
    copyrightAfter: ".",
  },
  products: {
    qv1: {
      ...
      cards: [
        {
          title: "4 AI stems — free (Evaluation)",
        ...
        {
          title: "On your PC",
          text: "Separation runs locally. The app goes online to download models and to check for updates.",
        },
      ],
      faqs: [
        {
        ...
        },
        {
          ...
          a: "Audio is processed locally and is not uploaded. The app goes online only to download models from a GitHub Release and to check for updates.",
        },
        {
  ...
  toolsIndex: {
    ...
    "mp4-to-mp3": {
      ...
      description: "Extract MP3, WAV, FLAC, AAC, OGG, Opus, AIFF, or WMA from many videos at once. Files stay on your device.",
    },
    "video-converter": {
      title: "Video converter",
      description: "Convert videos to MP4, WebM, MKV, MOV, AVI, or GIF in a batch. Remux when you can, or re-encode. Nothing is uploaded.",
    },
    "mp3-to-wav": {
  ...
  mp4ToMp3: {
    ...
    dropTitle: "Drop videos here or click to choose",
    dropHint:
      "MP4, MOV, MKV, WebM, AVI, MPEG, TS, and other common videos. One audio format for the whole batch. Files never leave this device.",
    addMoreTitle: "Drop more videos to add to the queue",
    addMoreHint: "New files are appended. Format and quality apply to every file.",
    replaceTitle: "Drop videos to add to the queue",
    replaceHint: "Files stay on this device. Nothing is uploaded.",
    empty: "The queue and audio previews appear here after you choose videos.",
    waiting: "Convert the queue to preview each audio file.",
    selectedFile: "Selected video",
    original: "Original size",
    output: "{format} size",
    format: "Output format",
    unifiedHint: "One format and quality for every video in this batch.",
    privacy: "Files never leave this device. Each file is removed from the converter memory when it finishes.",
    formats: {
      mp3: "MP3",
      wav: "WAV",
      flac: "FLAC",
    ...
    badFormat: "Unsupported format. Use a common video such as MP4, MOV, MKV, WebM, AVI, MPEG, or TS.",
    someSkipped: "Some files were skipped because they do not look like video.",
    failed: "Could not extract audio from this file. Try another video or a shorter clip.",
    ...
    failedMemory: "This file is too large for browser memory. Try a shorter clip.",
    failedAll: "None of the files could be converted. Check that they contain audio, or try again.",
    ...
    largeFileHint: "Files over 80 MB may fail because the whole video is loaded into memory. Files over about 250 MB are skipped.",
  ...
  videoConverter: {
    ...
    dropTitle: "Drop videos here or click to choose",
    dropHint:
      "MP4, MOV, MKV, WebM, AVI, MPEG, TS, and other common videos. Convert the batch to MP4, WebM, MKV, MOV, AVI, or GIF. Files never leave this device.",
    addMoreTitle: "Drop more videos to add to the queue",
    addMoreHint: "New files are appended. Container and quality apply to every file.",
    empty: "The queue and previews appear here after you choose videos.",
    output: "Output size",
    container: "Container",
    containers: {
      mp4: "MP4",
    ...
    transcode: "Re-encode",
    remux: "Remux (copy)",
    transcodeHint: "Re-encoding applies resolution, frame rate, and quality. Audio is AAC, Opus, or MP3 depending on the container.",
    remuxHint: "Copies streams with no re-encode. It fails on a file whose codecs do not fit the container. Scale and quality are ignored.",
    audio: "Audio",
    ...
    crf: "Quality (CRF)",
    crfValue: "CRF",
    crfHint: "Lower is sharper and larger. 23 is a strong default for H.264. VP9 starts near 32.",
    bitrate: "Bitrate",
    gifHint: "GIF keeps the picture only. Original frame rate exports at 12 fps so the file stays smaller.",
    unifiedHint: "One container and one set of options for every file in this batch.",
    privacy: "Files never leave this device. Each file is removed from the converter memory when it finishes.",
    filesCount: "{count} files",
    filesCountLabel: "Files",
    readyCount: "{count} ready",
    ...
    badFormat: "Unsupported format. Use a common video such as MP4, MOV, MKV, WebM, AVI, MPEG, or TS.",
    someSkipped: "Some files were skipped because they do not look like video.",
    failed: "Could not convert this file. Try another container, or turn remux off and re-encode.",
    failedEngine: "Could not load the conversion engine. Refresh the page and try again.",
    failedNoAudio: "This file has no usable video stream.",
    failedMemory: "This file is too large for browser memory. Try a shorter clip.",
    failedAll: "None of the files could be converted. Try re-encode instead of remux, or use a shorter clip.",
    failedSome: "{failed} of {total} files failed. Successful outputs are still available to download.",
    zipFailed: "Could not build the ZIP. Download files one by one instead.",
    largeFileHint: "Files over 80 MB may fail because the whole video is loaded into memory. Files over about 250 MB are skipped.",
  },
  ...
  toolPages: {
    ...
    "mp4-to-mp3": {
      ...
      title: "Convert video to audio — batch, no upload",
      description:
        "Extract MP3, WAV, FLAC, AAC, M4A, OGG, Opus, AIFF, or WMA from common videos. Queue many files, then download each one or a ZIP. Nothing is uploaded.",
      howToTitle: "How do I extract audio from videos?",
      howToNote: "The conversion engine loads into this tab only. One failing file does not stop the rest of the queue. Close the page and the files leave memory.",
      howToSteps: [
        "Drop one or more videos (MP4, MOV, MKV, WebM, AVI, MPEG, TS, and other common types).",
        "Choose one output format and the sample rate, channels, and bitrate that apply to it.",
        "Tap Extract audio. Watch each file’s progress, then download files or a ZIP.",
      ],
      faqs: [
        {
          q: "Do the videos leave my device?",
          a: "No. FFmpeg.wasm processes each file in your browser. We do not receive a copy.",
        },
        {
          q: "Which formats can I export?",
          a: "MP3, WAV, FLAC, M4A (AAC), raw AAC, OGG (Vorbis), Opus, AIFF, and WMA. WMA depends on the in-browser encoder and may fail on some clips.",
        },
        {
          q: "Can I convert many videos at once?",
          a: "Yes. They share one format and quality, run one after another, and you can cancel a file or the batch. A failure stays on that row.",
        },
        {
          q: "Why did one file fail?",
          a: "A clip with no soundtrack, a codec this browser build cannot decode, or a file too large for memory will fail on its own. Files over about 250 MB are skipped.",
        },
      ],
    },
    "video-converter": {
      category: "Audio & video tools",
      title: "Convert any video to any video — no upload",
      description:
        "Turn common videos into MP4 (H.264/AAC), WebM (VP9 or VP8/Opus), MKV, MOV, AVI, or GIF. Re-encode or remux compatible streams. Files stay on your device.",
      howToTitle: "How do I convert a video to another format?",
      howToNote:
        "Remux copies streams and only works when the codecs fit the container. Re-encode always rebuilds the picture. GIF drops audio. One failure does not stop the batch.",
      howToSteps: [
        "Drop one or more videos in any common container.",
        "Pick the container, codec, resolution, frame rate, quality, and whether to keep audio.",
        "Choose re-encode, or remux when you only need a new container.",
        "Tap Convert all, then download each file or a ZIP.",
      ],
      faqs: [
        {
          q: "Is the video uploaded?",
          a: "No. Conversion runs in this tab with FFmpeg. Files never leave the device.",
        },
        {
          q: "What does remux mean?",
          a: "Remux copies the existing video and audio into the new container without re-encoding. It is fast, and it fails when the codecs are not allowed in that container — for example VP9 into MP4.",
        },
        {
          q: "Which outputs are supported?",
          a: "MP4 and MOV use H.264 and AAC. WebM uses VP9 or VP8 with Opus. MKV can hold H.264 or VP9. AVI uses MPEG-4 and MP3. GIF is a silent animation.",
        },
        {
          q: "Why is a large file rejected?",
          a: "The browser loads the whole video into memory. Files over 80 MB may fail, and files over about 250 MB are skipped with a clear message.",
        },
      ],
    },
    "mp3-to-wav": {
  ...
  privacy: {
    ...
    qv1AppTitle: "13. QV1 desktop app",
    qv1App: [
      "QV1 Evaluation is a Windows desktop application. Audio you open in QV1 is processed locally on your computer and is never uploaded to QVI.",
      "The app goes online only to download models from a GitHub Release and to check for updates.",
      "Crash logs stay in %LOCALAPPDATA%\\QV1\\logs unless you choose to email them.",
      "When you are signed in and download the QV1 installer, we store the version, the time, and your browser’s user agent on your account so the account page can show your download history.",
    ],
    qv1AppContact: "Privacy questions about the desktop app:",
  ...
  studio: {
    ...
    gridHint: "The ruler follows the session BPM in the transport. That tempo does not time-stretch clips. Drag the ruler to select a time range. Shift-click selects more clips.",
    snap: "Snap",
    snapBar: "Bar",
    snapBeat: "Beat",
    snapOff: "Off",
    ...
    sessionBpm: "Session BPM",
    sessionBpmHint: "Grid, snap, and metronome. Typing commits with Enter. This does not time-stretch clips — use a track's tempo controls for that.",
    tapTempo: "Tap",
    tapTempoHint: "Tap along with the beat to set the session BPM. This does not time-stretch clips.",
    metronome: "Metronome",
