export const en = {
  ...
  studio: {
    ...
    gridHint: "The ruler counts bars from the selected track tempo. Shift-click selects more clips.",
    snap: "Snap",
    snapBar: "Bar",
    snapBeat: "Beat",
    snapOff: "Off",
    ...
    newProjectHint: "New project clears the saved session on this device.",
    ...
    keys: "Space plays or pauses. Home stops. Arrow keys seek.",
    timeline: "Timeline",
    export: "Export",
