...
export const qv1Changelog: readonly Qv1ChangelogEntry[] = [
  {
    ...
    notes: {
      en: [
        ...
        "Drum Split (DSP) into Kick, Snare, Hi-hat, and Other Drums works on any drum track. Stem editing, DSP processing, the mixer, mix export, and projects are QVI’s own code and are included in this free Evaluation.",
      ],
      ar: [
        ...
        "فصل الطبول (DSP) إلى كيك وسنير وهاي-هات وطبول أخرى يعمل على أي مسار طبول. تحرير الستيمز ومعالجة DSP والمكسر وتصدير المزيج والمشاريع كود QVI وهي داخل نسخة التقييم المجانية.",
      ],
    },
  },
];
